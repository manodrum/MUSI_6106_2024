...
//
// impl Vibrato {
//     pub fn new(sample_rate_hz: f32, depth: f32, mod_freq: f32) -> Self {
//         Vibrato {
//             buffer: RingBuffer::new((max_delay_secs * sample_rate_hz) as usize),
//             lfo : WaveTableLfo::new(sample_rate_hz /mod_freq), // Example wavetable size,
//             sample_rate_hz,
//             depth: depth, // Initialize with default values
//             freq: mod_freq,  // Will be set properly using set_param
//         }
//     }
//
...
//         let sine_wave_freq = 440.0; // Frequency of the sine wave (A4 note)
//         let duration_secs = 2; // Duration of the audio signal in seconds
//         let num_samples = duration_secs * sample_rate_hz as usize / sine_wave_freq as usize; // Number of samples for 1 cycle
//
//         let sine_wave: Vec<f32> = (0..num_samples)
//             .map(|i| {
//                 let t = i as f32 / sample_rate_hz;
...
//             .collect();
//
//         // Printing sine_wave and vibrato
//         println!("sine_wave: {:?}", sine_wave);
//         println!("vibrato: {:?}", vibrato_signal);
//
//
//
//         // Assertions
